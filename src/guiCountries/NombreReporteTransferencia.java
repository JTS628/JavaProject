...
public class NombreReporteTransferencia extends javax.swing.JFrame {
    ...
    /**
     * Creates new form NombreReporteTransferencia
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ReporteUsuarios crearRepTransferencia = new ReporteUsuarios(Nombrereportetransf.getText(),b.FechaActual()/*new Date().toString()*/,"C:/Users/JJ/OneDrive/Escritorio/U/Progra 1/Java Project/JavaProject/src/Imagenes/icono.png",listaUsuarios);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NombreReporteTransferencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NombreReporteTransferencia().setVisible(true);
            }
        });
    }
